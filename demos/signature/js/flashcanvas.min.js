/*
 FlashCanvas, 2012-08-16T21:49 commit ID 50f7fe31ba62e087784f70434c2dd9cf9722832d
...
window.ActiveXObject && !window.CanvasRenderingContext2D && function () {
    function C (a) {
        return ((a[B + "Options"] || {}).swfPath || J) + "flashcanvas.swf"
    }
    function r (a) {
        ...
        if (t)
            for (H = n[t - 1].src || ""; t;) {
                ...
                if (script.src && script.src.match("flashcanvas")) {
                    n = 8 <= F.documentMode ? script.src : script.getAttribute("src", 4);
                    break a
                }
                t--
            }
    ...
    var J = n.replace(/[^\/]+$/, ""),
        ...
        v = function (a, b) {
            ...
            this._executeCommandIntervalID = setInterval(function () {
                ...
                b ? 0 === p[c._canvasId] && c._executeCommand() : clearInterval(c._executeCommandIntervalID)
            }, 30)
        };
    v.prototype = {
        save: function () {
            ...
            this._setLineStyles();
            this._setFontStyles();
            this._stateStack.push([this._globalAlpha, this._globalCompositeOperation, this._strokeStyle,
            this._fillStyle, this._lineWidth, this._lineCap, this._lineJoin, this._miterLimit,
            this._shadowOffsetX, this._shadowOffsetY, this._shadowBlur, this._shadowColor, this
                ._font, this._textAlign, this._textBaseline]);
            this._queue.push(e.save)
        },
        restore: function () {
            var a = this._stateStack;
            a.length && (a = a.pop(), this.globalAlpha = a[0], this.globalCompositeOperation = a[1], this.strokeStyle =
                a[2],
                this.fillStyle = a[3], this.lineWidth = a[4], this.lineCap = a[5], this.lineJoin = a[6],
                this.miterLimit = a[7], this.shadowOffsetX = a[8], this.shadowOffsetY = a[9], this.shadowBlur =
                a[10], this.shadowColor = a[11], this.font = a[12], this.textAlign = a[13], this.textBaseline =
                a[14]);
        ...
        _setCompositing: function () {
            var a = this._queue;
            this._globalAlpha !== this.globalAlpha && (this._globalAlpha = this.globalAlpha, a.push(e.globalAlpha,
                this._globalAlpha));
            this._globalCompositeOperation !== this.globalCompositeOperation && (this._globalCompositeOperation =
        ...
        _setStrokeStyle: function () {
            if (this._strokeStyle !== this.strokeStyle) {
                ...
                if ("string" !== typeof a)
                    if (a instanceof q || a instanceof y) a = a.id;
                    else return;
        ...
        createRadialGradient: function (a, b, c, d, f, g) {
            (!isFinite(a) || !isFinite(b) || !isFinite(c) || !isFinite(d) || !isFinite(f) || !isFinite(g)) &&
                i(9);
            (0 > c || 0 > g) && i(1);
        ...
        createPattern: function (a, b) {
            ...
            if (c)
                if (c = c.toLowerCase(), "img" === c) d = a.getAttribute("src", 2);
                    ...
                    if (c === s || "video" === c) return;
                    i(17)
                }
            else a.src ? d = a.src : i(17);
            "repeat" === b || ("no-repeat" === b || "repeat-x" === b || "repeat-y" ===
                b || "" === b || null === b) || i(12);
            this._queue.push(e.createPattern, r(d), b);
            !o[f][d] && u[f] && (this._executeCommand(), ++p[f], o[f][d] = !0);
            return new y(this)
        },
        _setLineStyles: function () {
            var a = this._queue;
            this._lineWidth !== this.lineWidth && (this._lineWidth = this.lineWidth, a.push(e.lineWidth,
                this._lineWidth));
        ...
        _setShadows: function () {
            var a = this._queue;
            this._shadowOffsetX !== this.shadowOffsetX && (this._shadowOffsetX = this.shadowOffsetX, a.push(
                e.shadowOffsetX, this._shadowOffsetX));
            this._shadowOffsetY !== this.shadowOffsetY && (this._shadowOffsetY = this.shadowOffsetY, a.push(
                e.shadowOffsetY, this._shadowOffsetY));
            this._shadowBlur !== this.shadowBlur && (this._shadowBlur = this.shadowBlur, a.push(e.shadowBlur,
                this._shadowBlur));
            this._shadowColor !==
        ...
        _setFontStyles: function () {
            ...
            this._textAlign !== this.textAlign && (this._textAlign = this.textAlign, a.push(e.textAlign,
                this._textAlign));
            this._textBaseline !== this.textBaseline && (this._textBaseline = this.textBaseline, a.push(e.textBaseline,
                this._textBaseline));
            this._direction !== this.canvas.currentStyle.direction && (this._direction = this.canvas.currentStyle
                .direction, a.push(e.direction, this._direction))
        },
        fillText: function (a, b, c, d) {
            ...
            this._setShadows();
            this._setFontStyles();
            this._queue.push(e.fillText, r(a), b, c, void 0 === d ? Infinity : d)
        },
        strokeText: function (a, b, c, d) {
            ...
            this._setShadows();
            this._setFontStyles();
            this._queue.push(e.strokeText, r(a), b, c, void 0 === d ? Infinity : d)
        },
        measureText: function (a) {
            ...
            return new K(b.offsetWidth)
        },
        drawImage: function (a, b, c, d, f, g, j, L, M) {
            a || i(17);
            var h = a.tagName,
            ...
            else if (9 === l) (0 === d || 0 === f) && i(1), this._queue.push(e.drawImage, l, k, b, c, d, f,
                g, j, L, M);
            else return;
            !o[z][k] && u[z] && (this._executeCommand(), ++p[z], o[z][k] = !0)
        },
        ...
        loadImage: function (a, b, c) {
            ...
            if (f && !o[g][f]) {
                if (b || c) w[g][f] = [a, b, c];
                this._queue.push(e.drawImage, 1, r(f));
                u[g] && (this._executeCommand(), ++p[g], o[g][f] = !0)
            }
        },
        _initialize: function () {
            ...
            this.shadowBlur = this._shadowBlur = this.shadowOffsetY = this._shadowOffsetY = this.shadowOffsetX =
        ...
        _executeCommand: function () {
            var a = this._flush();
            if (0 < a.length) return eval(this._swf.CallFunction(
                '<invoke name="executeCommand" returntype="javascript"><arguments><string>' + a
            ...
            initWindow: function (a) {
                function b () {
                    if ("complete" === a.document.readyState) {
                        a.document.detachEvent(G, b);
                        for (var c = a.document.getElementsByTagName(s),
                            d = 0, e = c.length; d < e; ++d) m[I](c[d])
                    }
                }
                var c = a.document;
                c.createElement(s);
                c.createStyleSheet().cssText = s +
                ...
                var d = this.canvases,
                    ...
                    g = function () {
                        ...
                        var b, c, h, k, l, j, A;
                        for (A in d)
                            if (b = d[A], c = b.firstChild, k = b.ownerDocument.defaultView ? b.ownerDocument.defaultView :
                                b.ownerDocument.parentWindow, a === k) {
                                for (h in c) "function" === typeof c[h] && (c[h] = void 0);
                                for (h in b) "function" === typeof b[h] && (b[h] = void 0);
                                k = 0;
                                for (l = e[A].length; k !== l; k++) j = e[A][k], c.detachEvent(j[0], j[1]), b.detachEvent(
                                    j[0], j[1])
                            } a.CanvasRenderingContext2D = void 0;
                        a.CanvasGradient = void 0;
                        a.CanvasPattern = void 0;
                        a[B] = void 0
                    };
                a.attachEvent("onunload", g);
                a.CanvasRenderingContext2D = v;
                a.CanvasGradient = q;
                a.CanvasPattern = y;
                a[B] = m;
                var j = C(a);
                ...
                "complete" === a.document.readyState ? b() :
                    a.document.attachEvent(G, b)
            }
        };
    m[I] = function (a) {
        ...
        E(a);
        var g = C(c);
        a.innerHTML = '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="' + ("https:" ===
            c.location.protocol ? "https:" : "http:") +
            '//fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="100%" height="100%" id="' +
            f + '"><param name="allowScriptAccess" value="always"><param name="flashvars" value="id=' + f +
        ...
        if (i(a)) j.movie = g;
            ...
            i(a) && (clearInterval(m), j.movie = g)
        }, 2);
        if ("BackCompat" === b.compatMode || !c.XMLHttpRequest) x[d].style.overflow =
            "hidden";
        var h = new v(a, j);
        ...
        a.toDataURL = function (a, b) {
            "image/jpeg" === ("" + a).toLowerCase() ? h._queue.push(e.toDataURL, a, "number" === typeof b ?
                b : "") : h._queue.push(e.toDataURL, a);
    ...
    m.unlock = function (a, b, c) {
        try {
            ...
            if (void 0 === b) d = this.canvases[a], e = d.firstChild, k = d.ownerDocument, l = k.defaultView ?
                k.defaultView : k.parentWindow, E(d), g = d.width, j = d.height, d.style.width = g + "px", d.style
                    .height = j + "px", 0 < g && (e.width = g), 0 < j && (e.height = j), e.resize(g, j), b =
                function (a) {
                    var a = a ? a : l.event,
                        b = a.propertyName;
                    if (b === "width" || b === "height") {
                        var a = a.srcElement,
                            c = a[b],
                            d = parseInt(c, 10);
                        if (isNaN(d) || d < 0) d = b === "width" ? 300 : 150;
                        if (c === d) {
                            a.style[b] =
                                d + "px";
                            a.getContext("2d")._resize(a.width, a.height)
                        } else a[b] = d
                    }
                }, this.registeredEvents[a].push(["onpropertychange", b]), d.attachEvent("onpropertychange", b),
                u[a] = !0, "function" === typeof d.onload && l.setTimeout(function () {
                    d.onload()
                }, 0);
            else if (i = w[a][b]) m = i[0], h = i[1 + c], delete w[a][b], "function" === typeof h && h.call(m);
            p[a] && --p[a]
        } catch (n) {
    ...
    m.initWindow(this, F);
    keep = [v.measureText, v.loadImage]
}.call(window);